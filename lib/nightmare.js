...
/**
 * actions.js中的方法是挂载到Nightmare.prototype上的, 通过Nightmare.action挂载的.
 */
...
/**
 * Initialize `Nightmare`  // 初始化 `Nightmare`
 *
 * @param {Object} options
 */

function Nightmare(options) {
  // 强制用户以构造函数的方式使用Nightmare
